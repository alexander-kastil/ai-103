...
DEFAULT_PROMPT = "Find me the next event I can see from South America and give me the cost for 5 hours of premium telescope time at normal priority."
...
def main():
    ...
    with (
        ...
        while True:
            user_input = input(f"Enter a prompt for the astronomy agent. Use 'quit' to exit.\n[default: {DEFAULT_PROMPT}]\nUSER: ").strip()
            if not user_input:
