...
agent_card = AgentCard(
    name='Microsoft Foundry Outline Agent',
    description='An intelligent outline generator agent powered by Foundry. '
...
async def health_check(request: Request) -> PlainTextResponse:
    return PlainTextResponse('Microsoft Foundry Outline Agent is running!')
...
def main():
    ...
    try:
        ...
        print('Outline Agent server stopped.')
