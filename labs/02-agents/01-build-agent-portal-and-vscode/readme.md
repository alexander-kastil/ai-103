...
1. Locate the IT policy document in the lab assets folder: `assets/IT_Policy.txt`.
...
1. To the right of **Add**, select **Upload files**. Under **Attach files**, browse to and upload `assets/IT_Policy.txt`, and then select **Attach**.

1. Wait for the file to be indexed. You'll see a confirmation when it's ready.

1. Now let's add some performance data for the code interpreter to analyze. Locate the system performance data file in the lab assets folder: `assets/system_performance.csv`.

1. To the right of **</> Code interpreter**, select **+ Files**, and then upload `assets/system_performance.csv`.
