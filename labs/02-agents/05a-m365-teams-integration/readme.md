...
3. Locate the sample policy documents in the `assets/` folder of this lab:
   - `assets/it_security_policy.txt` — IT Security Policy
   - `assets/remote_work_policy.txt` — Remote Work Policy

4. Return to your agent's configuration, scroll to the **Tools** section.

5. Select **Upload files**.

6. A pop-up to attach files will appear. Attach the files from the `assets/` folder.
